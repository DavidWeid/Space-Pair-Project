    ...
    <div style={{ height: "100%" }}>
      ...
      <div className="fullArea">
        <div className="outputArea">
          ...
          <h1 className="pageTitle">Mars Rovers</h1>
          <div className="redLine"></div>
          <img
          ...
          <div className="redLine"></div>
          <h2 className="pageTitle">Conclusion</h2>
          <div className="redLine"></div>
          <p>
          ...
          <p>
            It will probably take humans setting foot on Mars to find definite answers to these questions. Perhaps, in the future, there will be actual canals on Mars, crossing the surface, carrying the very water Curiosity found to colonies of people who want to explore.
          </p>
        </div>
      </div>
    </div>
